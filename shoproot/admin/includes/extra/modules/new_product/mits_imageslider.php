...
<table class="tableInput border0">
  <tr>
    ...
    <td valign="top"><span class="main"><?php echo xtc_draw_pull_down_menu('imagesliders_group', $slidergroups_array, ((isset($pInfo->imagesliders_group)) ? $pInfo->imagesliders_group : '')); ?></span></td>
  </tr>
</table>
<script>
  $(document).ready(function() {
    $("[name='imagesliders_group']").closest("tr").detach().insertAfter($("[name='options_template']").closest("tr"));
  });
</script>
<?php
}