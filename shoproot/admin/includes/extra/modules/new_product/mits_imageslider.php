...
if (defined('MODULE_MITS_IMAGESLIDER_STATUS') && MODULE_MITS_IMAGESLIDER_STATUS == 'true') {
  ...
  <table class="tableInput border0">
    <tr>
      ...
      <span class="main">
            <?php echo TEXT_IMAGESLIDERS_GROUP; ?>
      </span>
      </td>
      <td valign="top">
      <span class="main">
          <?php echo xtc_draw_pull_down_menu('imagesliders_group', $slidergroups_array, ((isset($pInfo->imagesliders_group)) ? $pInfo->imagesliders_group : '')); ?>
      </span>
      </td>
    </tr>
  </table>
