    ...
    if (strstr($PHP_SELF, FILENAME_CONTENT_MANAGER)) {
        if (isset($_GET['coID']) && !empty($_GET['coID'])) {
          ...
          <table class="tableConfig borderall">
            <tr>
              <td class="dataTableConfig col-left" style="width:260px;">
                  <?php echo TEXT_IMAGESLIDERS_GROUP; ?>
              </td>
              <td class="dataTableConfig col-single-right">
                  <?php echo xtc_draw_pull_down_menu('imagesliders_group', $slidergroups_array, ((isset($slidergroup['imagesliders_group'])) ? $slidergroup['imagesliders_group'] : '')); ?>
              </td>
            </tr>
          </table>
          <script>
